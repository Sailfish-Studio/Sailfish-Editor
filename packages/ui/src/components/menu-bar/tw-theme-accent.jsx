...
const options = defineMessages({
    [ACCENT_RED]: {
        defaultMessage: 'Red',
        description: 'Name of the red color scheme, used by Sailfish-Studio by default.',
        id: 'tw.accent.red'
    },
    [ACCENT_PURPLE]: {
        ...
        >
            ...
            <span className={styles.submenuLabel}>
                <FormattedMessage
                    ...
                    description="Label for menu to choose accent color (eg. Sailfish-Studio's red, Scratch's purple)"
