...
import redoIcon from "./icon--redo.svg?url";
import undoIcon from "./icon--undo.svg?url";
...
import deleteIcon from "./icon--delete.svg?url";
import copyIcon from "./icon--copy.svg?url";
import pasteIcon from "./icon--paste.svg?url";
import copyToNewIcon from "./icon--copy-to-new.svg?url";
