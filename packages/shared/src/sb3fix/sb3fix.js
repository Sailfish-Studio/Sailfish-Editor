/*!
sb3fix - https://github.com/Sailfish-Studio/sb3fix
...
/**
 * @typedef {'scratch'|'sailfish-studio'} Platform
 */
...
const BUILTIN_EXTENSIONS = [
  ...
  'boost',
  'gdxfor'
  // intentionally not listing Sailfish-Studio's 'tw' extension here.
];
...
const fixJSON = (data, options = {}) => {
  ...
  const fixCommentInPlace = (id, comment) => {
    ...
    // We'll store the excess in .extraText so the text won't be truncated if opened in Sailfish-Studio.
