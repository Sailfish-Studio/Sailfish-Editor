...
```html
<!-- for scaffolding-min: -->
<script src="https://cdn.jsdelivr.net/npm/@sailfish-studio/packager@0.0.0/dist/scaffolding/scaffolding-min.js"></script>

<!-- for scaffolding-full -->
<script src="https://cdn.jsdelivr.net/npm/@sailfish-studio/packager@0.0.0/dist/scaffolding/scaffolding-full.js"></script>
```
...
```js
// for scaffolding-min:
require('@sailfish-studio/packager/dist/scaffolding/scaffolding-min.js');
// for scaffolding-full:
require('@sailfish-studio/packager/dist/scaffolding/scaffolding-full.js');

// or, if you prefer ES6 imports,
// for scaffolding-min:
import '@sailfish-studio/packager/dist/scaffolding/scaffolding-min.js';
// for scaffolding-full:
import '@sailfish-studio/packager/dist/scaffolding/scaffolding-full.js';
```
