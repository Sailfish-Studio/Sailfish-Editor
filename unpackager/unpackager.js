...
var unpackage = (function(JSZip) {
  ...
  if (!JSZip) {
    if (typeof require === 'function') {
      JSZip = require('@sailfish-studio/jszip');
    } else {
  ...
  const decodeBase85WithLengthHeader = (str) => {
    const decode_1 = (str) => {
      ...
      // https://github.com/Sailfish-Studio/packager/blob/9234d057585132d2514a831476abbcf2a7b9b151/src/packager/lib/base85-encode.js
    ...
    const decode_2 = (str) => {
      ...
      // https://github.com/Sailfish-Studio/packager/blob/44638a3f6daf03290c4020c5fd0d022edc1d0229/src/packager/lib/base85-encode.js
    ...
    const decode_3 = (str) => {
      ...
      // https://github.com/Sailfish-Studio/packager/blob/61b6905853320332dd44b08f9f7ab03c4b3542b9/src/packager/base85.js
      const getValue = (code) => {
        if (code === 0x28) code = 0x3c;
        if (code === 0x29) code = 0x3e;
        return code - 0x2a;
  ...
  const unpackage = async (data) => {
    ...
    if (packagedZip) {
      // Raw sb2, raw sb3, and zip files generated by Sailfish-Studio Packager have a project.json alongside the assets.
      ...
      if (projectJSON) {
        ...
        // importing @sailfish-studio/json. Only count as sb2 if we saw an sb2-style asset name and
      ...
      const projectBinary = (
        // Zip files generated by the Sailfish-Studio Packager, the legacy Sailfish-Studio Packager, or the forkphorus packager
    ...
    // HTML files generated by some versions of the Sailfish-Studio Packager use base85 in several inline script tags
    // that decode progressively (For simplicity we still just concatenate)
    // https://github.com/Sailfish-Studio/packager/pull/861
    ...
    // HTML files generated by some versions of the Sailfish-Studio Packager use base85 in one big script tag
    let base85Match = (
      // https://github.com/Sailfish-Studio/packager/commit/45838ee9ced603058b774587b01808c2fae991ec
      text.match(/const result = base85decode\("(.+)"\);/) ||
      // https://github.com/Sailfish-Studio/packager/commit/44638a3f6daf03290c4020c5fd0d022edc1d0229
    ...
    const dataURIMatch = (
      // HTML files generated by old version of the Sailfish-Studio Packager use inline base64
      // https://github.com/Sailfish-Studio/packager/blob/33b7b8c43986485a97e6885a2bb004d6fcc20b08/src/packager/packager.js#L362-L368
      ...
      // HTML files generated by the legacy Sailfish-Studio Packager use an inline base64 URL
    ...
    // If the file depends on "script.js" then it was packaged by Sailfish-Studio Packager as a zip
    ...
    if (
      ...
      // Sailfish-Studio Packager's Scaffolding will add various elements:
