...
```html
<!-- Do ONE of these: -->
<script src="https://cdn.jsdelivr.net/npm/@sailfish-studio/scaffolding@0.0.0/dist/scaffolding-min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@sailfish-studio/scaffolding@0.0.0/dist/scaffolding-with-music.js"></script>
...
<script type="module">
    // Do ONE of these:
    import "https://cdn.jsdelivr.net/npm/@sailfish-studio/scaffolding@0.0.0/dist/scaffolding-min.js";
    import "https://cdn.jsdelivr.net/npm/@sailfish-studio/scaffolding@0.0.0/dist/scaffolding-with-music.js";
    await import("https://cdn.jsdelivr.net/npm/@sailfish-studio/scaffolding@0.0.0/dist/scaffolding-min.js");
    await import("https://cdn.jsdelivr.net/npm/@sailfish-studio/scaffolding@0.0.0/dist/scaffolding-with-music.js");
...
```bash
npm install --save-exact @sailfish-studio/scaffolding
```
...
const Scaffolding = require('@sailfish-studio/scaffolding');
const Scaffolding = require('@sailfish-studio/scaffolding/with-music');
```
...
import * as Scaffolding from '@sailfish-studio/scaffolding';
import * as Scaffolding from '@sailfish-studio/scaffolding/with-music';
const Scaffolding = await import('@sailfish-studio/scaffolding');
const Scaffolding = await import('@sailfish-studio/scaffolding/with-music');

// DO NOT do one of these, it WILL NOT work:
import Scaffolding from '@sailfish-studio/scaffolding';
import Scaffolding from '@sailfish-studio/scaffolding/with-music';
```
