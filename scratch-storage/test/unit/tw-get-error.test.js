...
test('get() returns a somewhat useful error message', async () => {
    ...
    try {
        await tool.get({
            url: 'https://something.sailfish-studio.org/1234.png'
        });
    } catch (e) {
        error = e;
    }
    ...
    expect(error.toString()).toMatch(
        /Storage request https:\/\/something.sailfish-studio.org\/1234.png failed: Error: Intentional error for testing/
    );
});
