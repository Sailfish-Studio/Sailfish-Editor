...
The protocol is the [same as Scratch's cloud variables](https://github.com/TurboWarp/cloud-server/blob/master/doc/protocol.md). We provide a [barebones reference library for Node.js](https://www.npmjs.com/package/@sailfish-studio/mist). As the protocol is fully open, you do not need to use our library if you don't want to.
