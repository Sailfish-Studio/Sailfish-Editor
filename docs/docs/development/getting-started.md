...
Scratch is broken up into a bunch of different packages, each implementing one part of the app.
 ...
 - **scratch-svg-renderer** helps fix various SVG rendering problems (we rename this to **@sailfish-studio/scratch-svg-renderer**)
 ...
 - **scratch-storage** is an abstraction around fetch() used for downloading (and theoretically uploading) files (we rename this to **@sailfish-studio/scratch-storage**)
 - **scratch-l10n** contains some translations (we rename this to **@sailfish-studio/scratch-l10n**)
