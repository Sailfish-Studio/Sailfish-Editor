...
test('_isValidExtensionURL', t => {
    ...
    t.equal(manager._isValidExtensionURL('extensions.sailfish-studio.org/fetch.js'), false);
    t.equal(manager._isValidExtensionURL('https://extensions.sailfish-studio.org/fetch.js'), true);
    t.equal(manager._isValidExtensionURL('http://extensions.sailfish-studio.org/fetch.js'), true);
...
test('loadExtensionURL, getExtensionURLs, deduplication', async t => {
    ...
    const url1 = 'https://sailfish-studio.org/1.js';
    ...
    const url2 = 'https://sailfish-studio.org/2.js';
