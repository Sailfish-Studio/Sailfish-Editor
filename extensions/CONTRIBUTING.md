...
To learn how to write custom extensions, see our documentation:
 ...
 - https://docs.sailfish-studio.org/development/extensions/introduction
 - https://docs.sailfish-studio.org/development/extensions/unsandboxed
 - https://docs.sailfish-studio.org/development/extensions/compatibility
 - https://docs.sailfish-studio.org/development/extensions/better-development-server
...
These categories of extensions are **highly discouraged**:
 ...
 - Broad "Utilities" extensions. Break them up into multiple extensions instead. See https://github.com/Sailfish-Studio/extensions/issues/674 for discussion.
...
Sailfish-Studio's threat model is that loading a project in the editor should be no more dangerous than opening a PowerPoint. Projects can't affect anything outside of the editor without consent from the user. We offer a [bug bounty](https://github.com/Sailfish-Studio/extensions/security/policy) to people who find and report security bugs in merged extensions. Most guardrails can disappear once the project is packaged.
...
We're all volunteers who all have lives outside of Sailfish-Studio extensions. Many have full time jobs or are full time students. We'll get to you as soon as we can, so please be patient.
...
All extension are included in Sailfish-Studio Desktop which is licensed under the GPLv3. Thus, you need to use [a license that is compatible with GPLv3](https://www.gnu.org/licenses/license-list.en.html). This excludes:
...
Extensions should support being translated into any language. The development server and [volunteer translators](https://docs.sailfish-studio.org/translate) will handle the hard part. The developer's job is to use `Scratch.translate()` for any string that should be translated, such as block text or labels. Here's some examples to explain the idea:
