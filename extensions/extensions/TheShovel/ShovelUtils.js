  ...
  class ShovelUtils {
    getInfo() {
      return {
        ...
        color2: "#f54242",
        color3: "#f54242",
        docsURI: "https://extensions.sailfish-studio.org/TheShovel/ShovelUtils",
        blocks: [
          {
            opcode: "importImage",
          ...
          },
          {
            ...
            arguments: {
              TEXT: {
                type: Scratch.ArgumentType.STRING,
                defaultValue: "https://extensions.sailfish-studio.org/meow.mp3",
              },
              NAME: {
                type: Scratch.ArgumentType.STRING,
                defaultValue: "Meow",
          ...
          },
          {
            ...
            arguments: {
              TEXT: {
                type: Scratch.ArgumentType.STRING,
                defaultValue:
                  "https://extensions.sailfish-studio.org/samples/Box2D.sb3",
              },
            },
          },
          {
            ...
            arguments: {
              TEXT: {
                type: Scratch.ArgumentType.STRING,
                defaultValue: "https://extensions.sailfish-studio.org/utilities.js",
              },
            },
          },
