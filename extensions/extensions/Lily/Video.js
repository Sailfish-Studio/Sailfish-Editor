...
(function (Scratch) {
  ...
  // use display: none.
  // See https://github.com/Sailfish-Studio/scratch-render/issues/12
  ...
  class Video {
    ...
    getInfo() {
      return {
        ...
        docsURI: "https://extensions.sailfish-studio.org/Lily/Video",
        blocks: [
          {
          ...
          },
          {
            ...
            arguments: {
              URL: {
                ...
                defaultValue: "https://extensions.sailfish-studio.org/dango.mp4",
              },
              NAME: {
                type: Scratch.ArgumentType.STRING,
