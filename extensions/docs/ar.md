...
## Other information
 ...
 - It is generally recommended to use this extension with fps set to 0, which in sailfish-studio means running project at the screen refresh rate.
 - While exiting AR mode, there is a small chance Sailfish-Studio will lose WebGL context. This problem has also been observed on other websites with AR and likely can't be fixed. If that happens, you can save the project, refresh the tab, load the project and continue.
