...
>
> Examples include, but are not limited to: **Sailfish-Studio Desktop App, Sailfish-Studio Web App, Pop Up/Web App windows that contain the HTML packaged project, and plain Electron.**
>
