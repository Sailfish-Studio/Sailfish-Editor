...
import largeStageIcon from "./icon--large-stage.svg?url";
import smallStageIcon from "./icon--small-stage.svg?url";
import fullStageIcon from "./icon--full-stage.svg?url";
