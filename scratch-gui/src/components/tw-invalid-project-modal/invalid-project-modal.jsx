            ...
            {isZipCorruptionWithSignatureIntact(props.error) ? (
                <p>
                    <FormattedMessage
                        ...
                        // eslint-disable-next-line max-len
                        description="Part of modal that appears when a project could not be loaded. {usingSb3fix} becomes a link 'using sb3fix to recover your project'. sb3fix refers to https://sailfish-studio.github.io/sb3fix/"
                        id="tw.invalidProject.zipCorruption"
                        values={{
                            usingSb3fix: (
                                <a
                                    href="https://sailfish-studio.github.io/sb3fix/?platform=sailfish-studio"
                                    target="_blank"
                                    rel="noreferrer"
                                >
                                    <FormattedMessage
                                        ...
                                        // eslint-disable-next-line max-len
                                        description="Part of modal that appears when a project could not be loaded. Used in context 'Try using sb3fix to recover your project as it can fix this type of error'. sb3fix referes to https://sailfish-studio.github.io/sb3fix/"
                ...
                <p>
                    <FormattedMessage
                        ...
                        values={{
                            reportIt: (
                                <a
                                    href="https://github.com/Sailfish-Studio/sb3fix/issues"
                                    target="_blank"
                                    rel="noreferrer"
                                >
                                    <FormattedMessage
