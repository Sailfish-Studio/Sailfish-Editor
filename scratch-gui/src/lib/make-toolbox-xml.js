...
<block type="argument_reporter_boolean"><field name="VALUE">is Sailfish-Studio?</field></block>
`;
...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    ...
    // Always display Sailfish-Studio blocks as the first extension, if it exists,
